...
const token = localStorage.getItem('token')
  ...
  return (
    <>
      <div className="flex h-[70px] items-center fixed bg-[#14182A] ml-[240px] z-50 w-full" >
          ...
          <div className="flex">
            ...
            <div className="search w-full lg:flex items-center relative justify-center dropdown-search max-h-[400px]">
              <Dropdown menu={{ items }} trigger={['click']}>
                <Input onChange={(e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => onHandleSearch(e)} placeholder="Tìm kiếm bài hát ..." allowClear className="input-search w-full bg-[#1B2039] h-[40px] text-[14px] rounded-3xl focus:outline-none border-none placeholder: pl-9 lg:mx-auto lg:w-[30rem]" />
              </Dropdown>
            </div>
          </div>
          <div className="flex text-[#fff] mr-52">
            <div className=" bg-[#14182A] rounded-full">
            ...
            <div className="h-[40px] w-[40px] ml-5 flex items-center justify-center bg-[#14182A] rounded-full">
            ...
            <Dropdown overlay={menu} >
              <div className="h-[40px] w-[40px] flex items-center justify-center bg-[#14182A] rounded-full ml-5">
                <img src="/user-default.3ff115bb.png" className="rounded-full" onClick={(e) => e.preventDefault()} />
              </div>
            </Dropdown>
            </div>
            :
            <div className="flex px-[24px] py-[8px] items-center justify-center text-[#c273ee] bg-[#14182A] rounded-full ml-5">
