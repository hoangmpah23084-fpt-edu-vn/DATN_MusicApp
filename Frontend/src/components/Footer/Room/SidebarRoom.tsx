...
import { useStyles } from "./FooterRoom";
  // import { getFavourite } from "@/store/Reducer/favouriteReducer";
  type Props = {
    sideBarRight: boolean;
  };
  
  const SidebarRoom = (props: Props) => {
    ...
    return (
      <div
        className={`right-0 transition-all duration-700 ${props.sideBarRight ? "w-[500px]" : "fixed translate-x-[400px] w-0"
          } sticky z-50  border-l-[1px] border-[#120822] text-white h-[calc(100vh-70px)] bg-[#120822] bottom-[90px] fjc px-[8px]`}
      >
