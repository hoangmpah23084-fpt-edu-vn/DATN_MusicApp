...
import { ListItemButtonStyle, ListItemIconStyle, PauseListItemButtonStyle, PauseListItemIconStyle , ListItemIconBgStyle} from '@/Mui/style/Footer/StyleAction'
...
const SidebarSong = (props: Props) => {
  ...
  return (
    <div className={`right-0 transition-all duration-700 ${props.sideBarRight ? "w-[500px]" : "fixed translate-x-[400px] w-0"} sticky z-50  border-l-[1px] border-[#120822] text-white h-[calc(100vh-90px)] bg-[#120822] bottom-[90px] fjc px-[8px]`}>
          ...
          <div className='w-full h-[50%] px-[8px] flex'>
            ...
            <div className='w-[30%] h-full flex'>
              <div className='w-[50%] h-full'>
                <ListItemButtonStyle>
                  <ListItemIconBgStyle>
                    <AccessAlarmIcon sx={{ color :  "white", fontSize: "18px"}} />
                  </ListItemIconBgStyle>
                </ListItemButtonStyle>
              </div>
              <div className='w-[50%] h-full'>
        ...
        <div className='w-full fjc'>
          <div className='w-full h-[90%] '>
            ...
            <div className='w-full h-[50%]  flex justify-start items-center'>
              <h3 className='text-[14px] text-[rgba(254,255,255,0.6)] flex'>Từ playlist 
                ...
                <div className='w-[95%] h-[80%] flex justify-between '>
                  ...
                  <PauseListItemButtonStyle  onClick={() => globalPause && dataLocal?._id == item._id ? stopPause(item)  :  handStart(item, index)}>
                    ...
                    <div className='w-full h-full flex justify-start items-center relative wallSong'>
                      <img className='w-full h-full bg-cover rounded-[5px]'
