...
const MusicCharts = (props: Props) => {
  ...
  return (
    <div className="container">
      <div className="chanel-section-title mt-[100px] px-[15px] md:px-16 py-10 flex justify-between mb-[20px]">
      ...
      <section className="music_charts min-h-[300px] px-10 space-y-4">
        <div className="content px-10 py-2 hover:cursor-default space-y-3">
          {listSong?.map((song, index) => (
            <div
              key={index}
              className="item flex items-center space-x-5   hover:bg-stone-700 hover:rounded-md"
            >
