              ...
              <div className="playlist-header block w-[300px] float-left sticky top-[110px]">
                ...
                <div className="media-content text-center mt-[12px]">
                  <div className="content-top">
                    <h3 className="title text-[20px] font-semibold">Artist's Story #33 - Tăng Duy Tân: Viết nhạc để quên đi thực tại phũ phàng</h3>
                    <div className="release text-[12px] leading-7 text-[rgba(255,255,255,.5)]">Cập nhật: 13/10/2023</div>
                    <div className="artists text-[12px] leading-7 text-[rgba(255,255,255,.5)]">
                      <a className="is-ghost">
                        Tăng Duy Tân
                      </a>
                      
                    </div>
                    <div className="like text-[12px] leading-7 text-[rgba(255,255,255,.5)]">204K người yêu thích</div>
                  </div>
