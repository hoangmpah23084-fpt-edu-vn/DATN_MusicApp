...
const Room = () => {
    ...
    const [isShowModalCreateRoom, setIsShowModalCreateRoom] = useState<boolean>(false)
    ...
    return (<>
        ...
        {isShowModalCreateRoom && <ModalCreateRoom onShowModal={handleShowModalCreateRoom} />}
        <div className="text-white w-full h-[100%]">
            <div className='flex items-center justify-between mt-24 mx-16 '>
                ...
                <input type="text" className="bg-[#3a3244] ouline-none text-white text-sm rounded-lg block w-96 p-2.5" placeholder="Tìm phòng" required />
                <button className='relative bg-[#b76cea] min-w-[130px] py-2 rounded-full hover:bg-white hover:text-[#654789] flex items-center text-md text-center justify-center ease-in-out duration-300' onClick={() => handleShowModalCreateRoom()}>Tạo phòng <span className='text-xl font-bold ml-2'><FaPlus /> </span></button>
            </div>
